...
import com.ing.switchtojava.carpoolingapi.service.Position;
...
//    TrackingService trackingService;
    ...
    @GetMapping(value = "/{id}/flux", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    public Flux<Position> generateEvents(@PathVariable Long id) throws JAXBException, IOException {
        return trackingService.generateEvents(id);
    }
